...
const SliderComponent = () => {
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost:5000/cantidadPlatillos')
      .then((response) => {
        setTotalPlatillos(response.data.cantidad);
      })
      .catch((error) => {
  ...
  if (isNaN(id) || id < 1) {
    ...
    window.location.href = 'http://localhost:5173/mostrar-platillo/page/1';
